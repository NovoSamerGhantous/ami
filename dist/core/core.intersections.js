...
export default class Intersections {
    ...
    static aabbPlane(aabb, plane) {
        ...
        let planeAABB = this.posdir(plane.position.clone().applyMatrix4(aabb.toAABB), new Vector3(t1.x - t0.x, t1.y - t0.y, t1.z - t0.z).normalize());
        ...
        //    .'
        //   +
        let ray = this.posdir(new Vector3(aabb.center.x - aabb.halfDimensions.x, aabb.center.y - aabb.halfDimensions.y, aabb.center.z - aabb.halfDimensions.z), orientation.x);
        ...
        //           +
        //
        let ray2 = this.posdir(new Vector3(aabb.center.x + aabb.halfDimensions.x, aabb.center.y + aabb.halfDimensions.y, aabb.center.z + aabb.halfDimensions.z), orientation.x);
        ...
        //             .'
        //           +'
        let ray3 = this.posdir(new Vector3(aabb.center.x + aabb.halfDimensions.x, aabb.center.y - aabb.halfDimensions.y, aabb.center.z - aabb.halfDimensions.z), orientation.y);
        ...
        //
        //
        let ray4 = this.posdir(new Vector3(aabb.center.x - aabb.halfDimensions.x, aabb.center.y + aabb.halfDimensions.y, aabb.center.z - aabb.halfDimensions.z), orientation.x);
        ...
        //   |
        //   +-------+
        let ray5 = this.posdir(new Vector3(aabb.center.x - aabb.halfDimensions.x, aabb.center.y - aabb.halfDimensions.y, aabb.center.z + aabb.halfDimensions.z), orientation.x);
    ...
    static rayPlane(ray, plane) {
        ...
        if (ray.direction.dot(plane.direction) !== 0) {
            ...
            let intersection = new Vector3(ray.position.x + t * ray.direction.x, ray.position.y + t * ray.direction.y, ray.position.z + t * ray.direction.z);
            return intersection;
        }
        return null;
    }
    ...
    static rayBox(ray, box) {
        ...
        // console.log(bbox);
        // X min
        let plane = this.posdir(new Vector3(bbox.min.x, box.center.y, box.center.z), new Vector3(-1, 0, 0));
