...
export default class CoreUtils {
    ...
    static orderIntersections(points, direction) {
        ...
        let referenceDirection = new Vector3(points[0].x - reference.x, points[0].y - reference.y, points[0].z - reference.z).normalize();
        ...
        for (let j = 0; j < points.length; j++) {
            ...
            point.direction = new Vector3(points[j].x - reference.x, points[j].y - reference.y, points[j].z - reference.z).normalize();
