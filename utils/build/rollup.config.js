...
function addons() {
	...
	return {
		...
		transform(code, id) {
			...
			code = code.replace('build/ami.module.js', 'src/AMI.js');
...
function header() {
	...
	return {
		...
		renderChunk(code) {
			...
			return `/* -*- Mode: Java; tab-width: 2; indent-tabs-mode: nil; c-basic-offset: 2 -*- */
