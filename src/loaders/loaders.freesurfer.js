'use strict';
import { FreeSurferLoader, EventDispatcher, BufferGeometry, Vector3, BufferAttribute, Face3 } from 'three';

FreeSurferLoader = function () { };

Object.assign(FreeSurferLoader.prototype, EventDispatcher.prototype, {
    ...
    switch (surfType) {
      case FreeSurferLoader.QUAD_FILE_MAGIC_NUMBER: {
        ...
        for (let f = 0; f < faceCount; f++) {
          ...
          geometry.faces.push(new Face3(v1, v3, v4));
        }
