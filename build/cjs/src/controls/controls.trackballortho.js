 ...
 */
class trackballOrtho extends three_1.EventDispatcher {
    constructor(object, domElement, state = {
        ...
        let EPS = 0.000001;
        let _changed = true;
        let _state = STATE.NONE, _prevState = STATE.NONE, _eye = new three_1.Vector3(), _zoomStart = new three_1.Vector2(), _zoomEnd = new three_1.Vector2(), _touchZoomDistanceStart = 0, _touchZoomDistanceEnd = 0, _panStart = new three_1.Vector2(), _panEnd = new three_1.Vector2();
