 ...
 */
class widgetsCrossRuler extends widgets_base_1.widgetsBase {
    ...
    createMesh() {
        ...
        // mesh
        this._mesh = new three_1.LineSegments(this._geometry, this._material);
    ...
    recalculateOrtho() {
        ...
        const lines = [];
        const intersect = new three_1.Vector3();
        ...
        new three_1.Ray(this._handles[0].worldPosition, this._line01.clone().normalize()).closestPointToPoint(this._handles[activeInd].worldPosition, intersect);
    ...
    initCoordinates(first, second, third, fourth) {
        const intersectR = new three_1.Vector3();
        const intersectS = new three_1.Vector3();
        const ray = new three_1.Ray(first);
        ray.lookAt(second);
