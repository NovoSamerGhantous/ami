 ...
 */
class widgetsRectangle extends widgets_base_1.widgetsBase {
    ...
    createMesh() {
        this._geometry = new three_1.PlaneGeometry(1, 1);
    ...
    updateMeshPosition() {
        if (this._geometry) {
            const progection = new three_1.Vector3()
            ...
            this._geometry.vertices[1].copy(new three_1.Vector3().addVectors(this._handles[0].worldPosition, progection));
            this._geometry.vertices[2].copy(new three_1.Vector3().subVectors(this._handles[1].worldPosition, progection));
