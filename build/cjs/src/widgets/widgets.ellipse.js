 ...
 */
class widgetsEllipse extends widgets_base_1.widgetsBase {
    ...
    updateMeshPosition() {
        ...
        this._geometry = new three_1.ShapeGeometry(new three_1.Shape(new three_1.EllipseCurve(0, 0, width / 2, height / 2, 0, 2 * Math.PI, false).getPoints(50)));
