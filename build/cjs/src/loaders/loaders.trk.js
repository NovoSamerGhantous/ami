...
three_1.TRKLoader = function () { };
Object.assign(three_1.TRKLoader.prototype, three_1.EventDispatcher.prototype, {
    constructor: three_1.TRKLoader,
    ...
    parse: function (data) {
        ...
        while (offset < reader.byteLength) {
            ...
            track.geometry.setAttribute('position', new three_1.BufferAttribute(positions, 3));
            let index;
            index = 0;
            ...
            for (let p = 0; p < nbPoints; p++) {
                ...
                track.geometry.colors.push(new three_1.Color(diff[0], diff[1], diff[2]));
            }
