 ...
 */
class camerasOrthographic extends three_1.OrthographicCamera {
    ...
    init(xCosine, yCosine, zCosine, controls, box, canvas) {
        ...
        this._direction = new three_1.Vector3().crossVectors(this._right, this._up);
    ...
    rotate(angle = null) {
        ...
        let rotation = new three_1.Matrix4().makeRotationAxis(this._direction, (rotationToApply * Math.PI) / 180);
    ...
    _oppositePosition(position) {
        ...
        // rotate
        let rotation = new three_1.Matrix4().makeRotationAxis(this.up, Math.PI);
    ...
    _updateDirections() {
        ...
        // direction
        let pLocal = new three_1.Vector3(0, 0, -1);
        let pWorld = pLocal.applyMatrix4(this.matrixWorld);
        this._direction = pWorld.sub(this.position).normalize();
        // right
        this._right = new three_1.Vector3().crossVectors(this._direction, this.up);
