 ...
 */
class helpersStack extends three_1.Object3D {
    constructor(stack) {
        //
        super();
        this._stack = stack;
     ...
     */
    _prepareBBox() {
        const HelpersBoundingBoxConstructor = (0, helpers_boundingbox_1.helpersBoundingBox)();
     ...
     */
    _prepareBorder() {
        const HelpersBorderContructor = (0, helpers_border_1.helpersBorder)();
    ...
    _prepareSlice() {
        ...
        const SliceHelperConstructor = (0, helpers_slice_1.helpersSlice)();
    ...
    _prepareSlicePosition(rPosition, index) {
        let position = new three_1.Vector3(0, 0, 0);
        switch (this._orientation) {
            case 0:
                position = new three_1.Vector3(Math.floor(rPosition.x), Math.floor(rPosition.y), index);
                break;
            case 1:
                position = new three_1.Vector3(index, Math.floor(rPosition.y), Math.floor(rPosition.z));
                break;
            case 2:
                position = new three_1.Vector3(Math.floor(rPosition.x), index, Math.floor(rPosition.z));
                break;
            default:
                // do nothing!
                break;
    ...
    _prepareDirection(orientation) {
        let direction = new three_1.Vector3(0, 0, 1);
        switch (orientation) {
            case 0:
