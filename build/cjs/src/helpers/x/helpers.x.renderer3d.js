...
class default_1 {
    ...
    _initCamera() {
        this._camera = new three_1.PerspectiveCamera(45, this._container.clientWidth / this._container.clientHeight, 1, 10000000);
    ...
    _initScene() {
        ...
        // ambient
        this._scene.add(new three_1.AmbientLight(0x353535));
        // directional 1
        let directionalLight = new three_1.DirectionalLight(0xffffff, 1);
        directionalLight.position.set(200, 200, 1000).normalize();
        this._scene.add(directionalLight);
        // directional 2
        let directionalLight2 = new three_1.DirectionalLight(0xffffff, 1);
