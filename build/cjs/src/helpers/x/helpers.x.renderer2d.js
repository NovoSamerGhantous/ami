...
class default_1 {
    ...
    _setupCamera(stack) {
        ...
        let lpsDims = new three_1.Vector3(worldbb[1] - worldbb[0], worldbb[3] - worldbb[2], worldbb[5] - worldbb[4]);
        // box: {halfDimensions, center}
        let box = {
            center: stack.worldCenter().clone(),
            halfDimensions: new three_1.Vector3(lpsDims.x + 10, lpsDims.y + 10, lpsDims.z + 10),
        };
        // init and zoom
        let canvas = {
