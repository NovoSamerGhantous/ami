 ...
 */
class helpersVolumeRendering extends helpers_material_mixin_1.helpersMaterialMixin {
    constructor(stack) {
        //
        super();
        this._stack = stack;
    ...
    _prepareGeometry() {
        ...
        this._geometry = new three_1.BoxGeometry(worldBBox[1] - worldBBox[0], worldBBox[3] - worldBBox[2], worldBBox[5] - worldBBox[4]);
        this._geometry.applyMatrix4(new three_1.Matrix4().makeTranslation(centerLPS.x, centerLPS.y, centerLPS.z));
    }
    get uniforms() {
