...
class camerasOrthographic extends OrthographicCamera {
...
class geometriesSlice extends ShapeBufferGeometry {
  constructor(halfDimensions, center, position, direction, toAABB = new Matrix4()) {
    ...
    // BOOM!
    let intersections = Intersections.aabbPlane(aabb, plane);
 ...
 * @module helpers/lut
 */
class helpersLut extends Object3D {
  constructor(
    domTarget,
    lut = 'default',
    lutO = 'linear',
 ...
 */
class helpersMaterialMixin extends Object3D {
 ...
 * );
 */
class LoadersBase extends EventEmitter {
  /**
   * Create a Loader.
 ...
 */
class widgetsBase extends Object3D {
  /**
   * 
...
class widgetsEllipse extends widgetsBase {
  ...
  updateDOM() {
    ...
    // update ellipse
    this._ellipse.style.transform = `translate3D(${rectData.transformX}px, ${rectData.transformY
      }px, 0)`;
