...
class helpersMaterialMixin extends Object3D {
    ...
    _prepareTexture() {
        ...
        for (let m = 0; m < this._stack._rawData.length; m++) {
            let tex = new DataTexture(this._stack.rawData[m], this._stack.textureSize, this._stack.textureSize, this._stack.textureType, UnsignedByteType, UVMapping, ClampToEdgeWrapping, ClampToEdgeWrapping, NearestFilter, NearestFilter);
