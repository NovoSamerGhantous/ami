...
class helpersVolumeRendering extends helpersMaterialMixin {
    ...
    _prepareGeometry() {
        ...
        this._geometry = new BoxGeometry(worldBBox[1] - worldBBox[0], worldBBox[3] - worldBBox[2], worldBBox[5] - worldBBox[4]);
        this._geometry.applyMatrix4(new Matrix4().makeTranslation(centerLPS.x, centerLPS.y, centerLPS.z));
    }
    get uniforms() {
