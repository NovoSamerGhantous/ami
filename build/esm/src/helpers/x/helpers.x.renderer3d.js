...
import { DirectionalLight, AmbientLight, Scene, PerspectiveCamera, WebGLRenderer } from 'three';
export default class {
    ...
    _initCamera() {
        this._camera = new PerspectiveCamera(45, this._container.clientWidth / this._container.clientHeight, 1, 10000000);
