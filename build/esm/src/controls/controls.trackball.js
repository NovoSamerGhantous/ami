 ...
 */
class trackball extends EventDispatcher {
    constructor(object, domElement) {
        ...
        let _state = STATE.NONE, _prevState = STATE.NONE, _eye = new Vector3(), _movePrev = new Vector2(), _moveCurr = new Vector2(), _lastAxis = new Vector3(), _lastAngle = 0, _zoomStart = new Vector2(), _zoomEnd = new Vector2(), _touchZoomDistanceStart = 0, _touchZoomDistanceEnd = 0, _panStart = new Vector2(), _panEnd = new Vector2(), _customStart = new Vector2(), _customEnd = new Vector2();
        // for reset
        ...
        this.rotateCamera = (function () {
            let axis = new Vector3(), quaternion = new Quaternion(), eyeDirection = new Vector3(), objectUpDirection = new Vector3(), objectSidewaysDirection = new Vector3(), moveDirection = new Vector3(), angle;
            return function () {
        ...
        this.panCamera = (function () {
            let mouseChange = new Vector2(), objectUp = new Vector3(), pan = new Vector3();
            return function () {
