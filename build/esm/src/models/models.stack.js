...
export default class ModelsStack extends ModelsBase {
    ...
    prepare() {
        ...
        this._halfDimensionsIJK = new Vector3(this._dimensionsIJK.x / 2, this._dimensionsIJK.y / 2, this._dimensionsIJK.z / 2);
    ...
    computeIJK2LPS() {
        // ijk to lps
        this._ijk2LPS = CoreUtils.ijk2LPS(this._xCosine, this._yCosine, this._zCosine, this._spacing, this._origin, this._regMatrix);
        // lps 2 ijk
    ...
    AABBox() {
        ...
        let world7 = this._dimensionsIJK
            ...
            .applyMatrix4(this._ijk2LPS)
            .applyMatrix4(this._lps2AABB);
        let minBBox = new Vector3(Math.abs(world0.x - world7.x), Math.abs(world0.y - world7.y), Math.abs(world0.z - world7.z));
        return minBBox;
    }
    /**
